		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<% NewsHome newsHome =(NewsHome) request.getAttribute("newsHome"); %>
						<table class="table">
						<tr>
						 <th> Tiêu đề </th>
						 <td> <input class="form-control" type="text"  name="txtTieude" placeholder=<%=newsHome.getTieuDe()%>> </td>
						</tr>
						<tr>
						 <th> Nội dung </th>
						...
						<tr>
						 ...
						 <td class="text-center"> 
						 	<input class="btn btn-outline-warning " type="submit" value="Cập nhật">  
