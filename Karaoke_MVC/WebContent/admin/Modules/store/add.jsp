				...
				<div class="container-fluid">
					...
					<div>
						<div class="mx-auto text-center">
							<h2 class="text-danger">Thêm cửa hàng</h2>
						</div>
						<form action="http://localhost:8080/Karaoke_MVC/AddStoreServlet" method="post">
						<% ArrayList<Store> listCuaHang = (ArrayList<Store>)request.getAttribute("listCuaHang"); %>
							<table class="table">
								<tr>
									<th>Tên cửa hàng</th>
									<td> <input class="form-control" type="text" id="txtTenCuaHang" name="txtTenCuaHang" placeholder="Tên cửa hàng"> </td>
								</tr>
								<tr>
									<th>Số điện thoại</th>
									<td> <input class="form-control" type="text" id="txtSDT" name="txtSDT" placeholder="Số điện thoại"> </td>
								</tr>
								<tr>
									<th>Địa chỉ</th>
									<td> <input class="form-control" type="text" id="txtDiaChi" name="txtDiaChi" placeholder="Địa chỉ"> </td>
								</tr>
								<tr>
									<th>Khu vực</th>
