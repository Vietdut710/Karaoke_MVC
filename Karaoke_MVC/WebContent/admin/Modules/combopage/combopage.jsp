				...
				<div class="container-fluid">
					...
					<div>
						<div class="mx-auto text-center">
							<h2 class="text-danger">Chỉnh sửa Combo</h2>
						</div>
						<form action="http://localhost:8080/Karaoke_MVC/ShowAddComboPageServlet">
						...
						<table class="table text-center text-dark" >
							...
							<tr>
								...
								<td> 
									...
									<a class="btn btn-sm btn-outline-warning" href="http://localhost:8080/Karaoke_MVC/DeleteComboServlet" > Xóa </a>
								</td>
							</tr>
							<tr>
								<td> 2 </td>
