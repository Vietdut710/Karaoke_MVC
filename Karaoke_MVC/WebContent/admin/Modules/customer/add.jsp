				...
				<div class="container-fluid" >
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="card-body ">
								<div class="container">
									<form action="http://localhost:8080/Karaoke_MVC/AddCustomerServlet" method="post">
										<div class="form-group row">
											<div class="col-sm-10">
												<label class="font-weight-bold text-dark">Tên Khách Hàng</label>
												<input class="form-control" type="text" name="txtTenKhachHang" placeholder="Tên khách hàng">
											</div>
										</div>
										<div class="form-group row">
											<div class="col-sm-10">
										...
										<div class="form-group row">
											<div class="col-sm-10">
												...
												<input class=" " type="file" name="imgKhachHang">
											</div>											
										</div>									
