				...
				<div class="container-fluid">
					...
					<div>
						<div class="mx-auto text-center">
							<h2 class="text-danger">Thêm tin tức trang cửa hàng</h2>
						</div>
						<form
							action="http://localhost:8080/Karaoke_MVC/ShowAddHomePageServlet">
							<table class="table">
								<tr>
									<th>Cửa hàng</th>
									<td><select class="selectpicker">
											<optgroup label="Cửa hàng">
												...
												<option>Karaoke&Movie Lệ Thủy</option>
											</optgroup>
									</select></td>
								</tr>
								<tr>
									...
									<td><input class="form-control" type="number"
										name="txtSoluongphong" placeholder="Số lượng phòng"></td>
								</tr>
								<tr>
									<th>Nội dung</th>
									<td><textarea class="form-control" name="txtNoidung"
											placeholder="Nhập nội dung" rows="5"> </textarea></td>
								</tr>
								<tr>
									<th>Hình ảnh</th>
									<td><input class="" type="file" name="fileHinhAnh">
									</td>
								</tr>
								<tr>
									<th></th>
									<td class="text-center"><input
										class="btn btn-outline-warning " type="submit" value="Cập nhật">
